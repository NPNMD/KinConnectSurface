...
export function createMedicationRouter(
  ...
  router.get('/:medicationId', authenticateToken, async (req: any, res: any) => {
    try {
  ...
  router.put('/:medicationId', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
  ...
  // Delete a medication
  router.delete('/:medicationId', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
  ...
  router.get('/active/list', authenticateToken, async (req: any, res: any) => {
    try {
      const patientId = req.user!.uid;
  ...
  router.get('/search/:searchTerm', authenticateToken, async (req: any, res: any) => {
    try {
  ...
  router.get('/logs/all', authenticateToken, async (req: any, res: any) => {
    try {
      const patientId = req.user!.uid;
  ...
  router.get('/:medicationId/logs', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
  ...
  router.post('/:medicationId/logs', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
  ...
  router.put('/logs/:logId', authenticateToken, async (req: any, res: any) => {
    try {
  ...
  router.delete('/logs/:logId', authenticateToken, async (req: any, res: any) => {
    try {
      const { logId } = req.params;
  ...
  router.get('/reminders/all', authenticateToken, async (req: any, res: any) => {
    try {
      const patientId = req.user!.uid;
  ...
  router.get('/:medicationId/reminders', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
  ...
  router.post('/:medicationId/reminders', authenticateToken, async (req: any, res: any) => {
    try {
      const { medicationId } = req.params;
      ...
      const reminderData: NewMedicationReminder = {
        medicationId,
        patientId: req.user!.uid,
        ...req.body,
      };
  ...
  // Update a reminder
  router.put('/reminders/:reminderId', authenticateToken, async (req: any, res: any) => {
    try {
  ...
  // Delete a reminder
  router.delete('/reminders/:reminderId', authenticateToken, async (req: any, res: any) => {
    try {
      const { reminderId } = req.params;

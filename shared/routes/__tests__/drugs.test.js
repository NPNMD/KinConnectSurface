...
const drugs_1 = require("../drugs");
describe('Drug Routes', () => {
    let app;
    let mockDrugService;
    let mockRxImageService;
    let mockDailyMedService;
    ...
    beforeEach(() => {
        ...
        app.use('/drugs', (0, drugs_1.createDrugRouter)(mockDrugService, mockRxImageService, mockDailyMedService, mockAuthMiddleware));
        jest.clearAllMocks();
    });

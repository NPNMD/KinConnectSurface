...
const dailyMedService_1 = require("../dailyMedService");
...
describe('DailyMedService', () => {
    ...
    let originalFetch;
    beforeEach(() => {
        service = new dailyMedService_1.DailyMedService();
    ...
    describe('searchDrug', () => {
        ...
        it('should fetch drug search results and cache', async () => {
            ...
            const result = await service.searchDrug('aspirin');
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/spls.json?drug=aspirin'));

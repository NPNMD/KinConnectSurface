...
import { createMockRedisClient, mockConsole } from '../../__tests__/testUtils';
...
describe('CacheService', () => {
  ...
  describe('get', () => {
    beforeEach(() => {
      ...
      const readyCallback = mockRedisClient.on.mock.calls.find((call: any) => call[0] === 'ready')[1];
      readyCallback();
    });
    ...
    it('should return null when not connected', async () => {
      const disconnectedService = new CacheService();
  ...
  describe('clearVersion', () => {
    ...
    it('should clear all cache entries for version', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Cleared 2 cache entries')
      );
    });
  });
  ...
  describe('disconnect', () => {
    ...
    it('should gracefully disconnect', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('disconnected gracefully')
      );
    });
  ...
  describe('error handling', () => {
    ...
    it('should handle end event', () => {
      service = new CacheService();
      const endCallback = mockRedisClient.on.mock.calls.find((call: any) => call[0] === 'end')[1];

...
const drugService_1 = require("../drugService");
...
describe('DrugService', () => {
    ...
    let originalFetch;
    beforeEach(() => {
        service = new drugService_1.DrugService();
    ...
    describe('searchDrugs', () => {
        ...
        it('should search drugs from API and cache results', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/drugs.json?name=aspirin'));
            expect(mockCacheService.set).toHaveBeenCalledWith('drug', 'search:aspirin:10', expect.any(Array), 86400);
        ...
        it('should try approximate search if exact search returns no results', async () => {
            ...
            expect(global.fetch).toHaveBeenNthCalledWith(2, expect.stringContaining('/approximateTerm.json'));
            expect(results).toHaveLength(1);
        });
    ...
    describe('getDrugDetails', () => {
        ...
        it('should fetch drug details from API and cache', async () => {
            ...
            global.fetch = (0, testUtils_1.createMockFetch)(apiResponse);
            const result = await service.getDrugDetails('313782');
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/rxcui/313782/properties.json'));
            expect(mockCacheService.set).toHaveBeenCalledWith('drug', 'rxcui:313782', expect.any(Object), 86400);
    ...
    describe('getDrugInteractions', () => {
        ...
        it('should fetch interactions from API and cache', async () => {
            ...
            global.fetch = (0, testUtils_1.createMockFetch)(apiResponse);
            const result = await service.getDrugInteractions('313782');
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/interaction/interaction.json?rxcui=313782'));
    ...
    describe('getSpellingSuggestions', () => {
        ...
        it('should fetch spelling suggestions and cache', async () => {
            ...
            global.fetch = (0, testUtils_1.createMockFetch)(apiResponse);
            const result = await service.getSpellingSuggestions('asprin');
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/spellingsuggestions.json?name=asprin'));
            expect(mockCacheService.set).toHaveBeenCalled();
    ...
    describe('getRelatedDrugs', () => {
        ...
        it('should fetch related drugs and cache', async () => {
            ...
            global.fetch = (0, testUtils_1.createMockFetch)(apiResponse);
            const result = await service.getRelatedDrugs('313782');
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/rxcui/313782/related.json?tty=SBD+SCD+GPCK+BPCK'));
            expect(mockCacheService.set).toHaveBeenCalled();
    ...
    describe('error handling', () => {
        ...
        it('should handle malformed API responses', async () => {
            global.fetch = (0, testUtils_1.createMockFetch)(null);

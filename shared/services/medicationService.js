...
class MedicationService {
    ...
    async getMedicationLogsByPatientId(patientId) {
        try {
    ...
    async getMedicationLogsByMedicationId(medicationId) {
        try {
            const snapshot = await this.db.collection('medicationLogs')
    ...
    async getMedicationLogById(logId) {
        try {
    ...
    async updateMedicationLog(logId, updates) {
        try {
    ...
    async searchMedicationsByName(patientId, searchTerm) {
        try {
    ...
    async getActiveMedicationsByPatientId(patientId) {
        try {
            const snapshot = await this.db.collection('medications')
                .where('patientId', '==', patientId)
                .where('isActive', '==', true)
    ...
    async getMedicationRemindersByPatientId(patientId) {
        try {
    ...
    async getMedicationRemindersByMedicationId(medicationId) {
        try {
            const snapshot = await this.db.collection('medicationReminders')
                .where('medicationId', '==', medicationId)
                .get();
    ...
    async getMedicationReminderById(reminderId) {
        try {
    ...
    async updateMedicationReminder(reminderId, updates) {
        try {

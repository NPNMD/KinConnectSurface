...
const medicationCommandsApi_1 = __importDefault(require("./medicationCommandsApi"));
...
router.use('/time-buckets', timeBucketApi_1.default);
...
router.post('/migrate', async (req, res) => {
    try {
        ...
        const { patientId, dryRun = true, batchSize = 10 } = req.body;

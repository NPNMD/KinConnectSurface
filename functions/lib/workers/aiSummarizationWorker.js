...
exports.summarizeVisit = void 0;
exports.parseAISummary = parseAISummary;
exports.createMedicalSummaryPrompt = createMedicalSummaryPrompt;
exports.createTTSText = createTTSText;
...
exports.summarizeVisit = (0, pubsub_1.onMessagePublished)({
    ...
    firebase_functions_1.logger.info('🤖 Starting AI summarization', {
        visitId,
        uid,
    ...
    try {
        ...
        firebase_functions_1.logger.info('✅ AI summarization completed', {
            visitId,
        ...
        if (shouldGenerateTTS && summaryData.keyPoints && summaryData.keyPoints.length > 0) {
            ...
            firebase_functions_1.logger.info('📤 Published TTS request', { visitId });
        }
        firebase_functions_1.logger.info('🎉 Visit processing completed successfully', {
            visitId,
            finalStatus: shouldGenerateTTS ? 'tts' : 'ready'
        });
    }
    catch (error) {
        firebase_functions_1.logger.error('❌ AI summarization failed', {
            visitId,
            uid,
...
// Create medical visit analysis prompt
function createMedicalSummaryPrompt(transcript) {
    return `
...
function parseAISummary(aiResponse) {
    try {
        ...
        firebase_functions_1.logger.error('❌ Failed to parse AI response', {
...
// Create text for TTS
function createTTSText(summaryData) {
...
// Save summary files to Storage
async function saveSummaryFiles(uid, visitId, summaryData, rawResponse) {
    ...
    try {
        ...
        firebase_functions_1.logger.info('💾 Summary files saved to Storage', {
            visitId,
        ...
        firebase_functions_1.logger.error('❌ Failed to save summary files', {
            visitId,
...
function createMarkdownSummary(summaryData) {

...
app.get('/medication-calendar/schedules',
  authenticate,
  addDeprecationHeaders(
    '/medication-calendar/schedules',
    '/unified-medication/medication-commands',
    '2025-12-31'
  ),
  async (req, res) => {
	try {
...
app.post('/medication-calendar/schedules',
  authenticate,
  addDeprecationHeaders(
    '/medication-calendar/schedules',
    '/unified-medication/medication-commands',
...
app.put('/medications/:medicationId',
  authenticate,
  addDeprecationHeaders(
    '/medications/:medicationId',
    '/unified-medication/medication-commands/:id',

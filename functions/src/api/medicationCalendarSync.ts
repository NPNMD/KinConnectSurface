...
import { medicationCalendarSyncService } from '../services/MedicationCalendarSyncService';
import { googleCalendarMedicationSync } from '../services/GoogleCalendarMedicationSync';
...
router.post('/sync', async (req, res) => {
  try {
    ...
    // Perform sync
    const syncResult = await medicationCalendarSyncService.syncMedicationEvents(options);
...
router.get('/status', async (req, res) => {
  try {
    ...
    // Get sync status
    const statusResult = await medicationCalendarSyncService.getSyncStatus(targetPatientId);
...
router.post('/google/configure', async (req, res) => {
  try {
    ...
    // Configure sync
    const configResult = await googleCalendarMedicationSync.configureSyncSettings(
      userId,
      patientId,
      {
...
router.post('/google/sync', async (req, res) => {
  try {
    ...
    const syncResult = await googleCalendarMedicationSync.syncMedicationEventsToGoogle(
      targetPatientId,
      userId
    );
...
router.post('/google/import', async (req, res) => {
  try {
    ...
    const importResult = await googleCalendarMedicationSync.syncFromGoogleCalendar(
      targetPatientId,
      userId
    );
...
router.get('/google/status', async (req, res) => {
  try {
    ...
    // Get sync status
    const statusResult = await googleCalendarMedicationSync.getSyncStatusForPatient(
      userId,
      targetPatientId
    );
...
router.post('/google/disable', async (req, res) => {
  try {
    ...
    // Disable sync
    const disableResult = await googleCalendarMedicationSync.disableSync(userId, targetPatientId);
...
router.post('/batch-sync', async (req, res) => {
  try {
    ...
    // Perform batch sync
    const syncResult = await medicationCalendarSyncService.batchSyncPatientMedications(targetPatientId);

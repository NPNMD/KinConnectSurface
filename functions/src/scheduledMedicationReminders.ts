...
import { MedicationNotificationService, NotificationRequest } from './services/unified/MedicationNotificationService';
 ...
 */
export const scheduledMedicationReminders = functions
  .runWith({
    memory: '512MB',

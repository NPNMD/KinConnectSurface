 ...
 */
export function calculatePatientMidnight(date: Date = new Date(), timezone: string): Date {
 ...
 */
export function isWithinMidnightWindow(timezone: string, windowMinutes: number = 15): boolean {
  const now = new Date();
 ...
 */
export function calculateDayBoundaries(date: Date, timezone: string): {
  startOfDay: Date;
  endOfDay: Date;
 ...
 */
export function getPreviousDayBoundaries(timezone: string): {
  startOfDay: Date;
  endOfDay: Date;
  dateString: string;
} {
 ...
 */
export function belongsToDate(date: Date, targetDateString: string, timezone: string): boolean {
 ...
 */
export function getPatientsAtMidnight(
  allPatientTimezones: Map<string, string>,
  windowMinutes: number = 15
): string[] {
  const patientsAtMidnight: string[] = [];
